...
initialUserRepository = initialUserRepository.concat(
  ...
  createUser(1, 'john', '$2b$10$evxpiSvr1wYKA.m3srNLq..wztoyfIPywlEkFpZBnXeqA3zkW7KRS', 'John', 'Miller', 'john@example.com'),
);
initialUserRepository = initialUserRepository.concat(
  // plaintext password secret
  createUser(2, 'chris', '$2b$10$GAbzc2/Z7KcRs5jVmb5gyekjZ5XwjwKRYUgqtbyap2wl3mrq6QQo6', 'Chris', 'Myres', 'chris@example.com'),
);
initialUserRepository = initialUserRepository.concat(
  // plaintext password guess
  createUser(3, 'maria', '$2b$10$gKVCHzB5W/fn1cMTYbMV1O.WM/45Vq8tHEGszDhWsR4Px9UL3YP7.', 'Maria', 'Muller', 'maria@example.com'),
);
